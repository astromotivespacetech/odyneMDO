...
def cylinder_mass(a, t_c, l_c, rho):
    ...
    Returns:
        mass of cylinder tank [kilogram].
    '''
...
def sphere_wall_thickness(r, p, stress):
    ''' Calculates the wall thickness of a spherical tank '''
